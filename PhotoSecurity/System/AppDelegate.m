...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [AVOSCloud setApplicationId:@"J631tqDTtbXvBt7m5MnNrcf4-gzGzoHsz"
                      clientKey:@"ApJI3paxWGEGBsWpnRBSCbAS"
                serverURLString:@""];
    return YES;
}
...
//            UIStoryboard *mainStoryboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
//            UIViewController *unlockVc = [mainStoryboard instantiateViewControllerWithIdentifier:@"XPUnlockViewController"];
//            unlockVc.modalPresentationStyle = UIModalPresentationFullScreen;
//            [rootVc presentViewController:unlockVc animated:NO completion:nil];
//        }
//    }
}
