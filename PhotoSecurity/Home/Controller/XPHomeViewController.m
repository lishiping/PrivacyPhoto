...
//    SPWebVCDemo *web = [[SPWebVCDemo alloc]initWithURL:[NSURL URLWithString:@"https://www.c69gz.com"]];
    NSString *url = [LSPBundleTools getPathBundle:@"SPWebView" fileName:@"WebViewDemo.html"];
    SPWebVCDemo *web = [[SPWebVCDemo alloc]initWithURL:[NSURL fileURLWithPath:url]];

//    SPWebVCDemo *web = [[SPWebVCDemo alloc]initWithURLString:@"https://www.baidu.com"];
    web.useGoback = YES;
    web.isShowRightItem = YES;
